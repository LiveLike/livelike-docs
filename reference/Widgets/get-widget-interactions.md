...
3. Every widget interaction result will contain properties `next` and `previous`. These are optional urls that can be used in conjunction with your access token to retrieve more leaderboard entries.