...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/1a04fb9ee754dfee6f74d9e3499c5f3537c6af9f0b69185c49d3b47eac2a5c9b-image.png",
        null,
        "Open the message actions menu for the message, and select the appropriate Mute option."
      ],
      "align": "center",
      "caption": "Open the message actions menu for the message, and select Delete."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/2781cf99d41bcc5191366bf6473c813a79b068f43efae5805a395f0f737a8dbf-image.png",
        null,
        "Open the report action menu, and select Dismiss Report or Remove Message."
      ],
      "align": "center",
      "caption": "Open the report action menu, and select Dismiss Report or Remove Message."
    }
  ]
}
[/block]
  ...
  "images": [
    {
      ...
      "align": "center",
      "caption": "Open the message actions menu for the message, and select the appropriate Mute option."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/0cd8a19e00055af29c9295f3cb877dd44c48ca449025365e2dc9b3f303993a15-image.png",
        null,
        "Chat users in muted states."
      ],
      "align": "center",
      "caption": "Chat users in muted states."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/33d2203-Screenshot_2022-09-19_at_2.07.42_PM.png",
        "Screenshot 2022-09-19 at 2.07.42 PM.png",
        1270
      ],
      "align": "center",
      "caption": "Manual-Customization"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/d72c564-Screenshot_2022-09-19_at_2.07.49_PM.png",
        "Screenshot 2022-09-19 at 2.07.49 PM.png",
        1299
      ],
      "align": "center",
      "caption": "CSV-Upload"
