...
hidden: false
metadata:
  title: Editorial Strategy | Producer Suite | LiveLike Developer Hub
  description: >-
    This page will help Producers of Live events think through an editorial
    strategy for one or more events. Learn more.
  robots: index
next:
  description: ''
  pages:
    - type: basic
      slug: game-preparation
...
We generally recommend you aim for creating a widget every 2 or 3 minutes. Work backward from the length of your event and plan how many widget you will likely need to produce. For instance, if you are covering a Basketball game of 120-150mn and perhaps more with pre and post game. In this example, you may need to publish 60-75 widgets as a result during the game. If you don't think this your editorial guideline ahead of time this can be overwhelming so be sure to give yourself a little prep time before games.

It's important you avoid publishing during a play or intense game moment. Publish during injuries, the start of a commercial break, substitutions, time-outs, and other dull moment. This is easier if you queue widgets ahead of time and publish them at the opportune moment. Prep time will free up time for you to focus reacting to the audience, publishing widgets at the right moment, all based on what's happening in the game.

Also consider publishing widgets as a reaction to what's happening to chat. The chat is giving you the pulse of the audience and helps you be on point and playfully react to the conversation. Don't hesitate to drop a fun gif or widget in reaction to chat messages. For instance, publish the lineup if people in chat are asking about this. If chat is not enabled, you can use social media to keep tabs on how audiences are feeling about the game in a similar way.
...
Also consider when your want to bring these interactions. Perhaps you will want to breakdown the 8 predictions into 2 in pre-game and 2 at the start of each quarter. Maybe the first prediction is more easy and wide reaching and the second one is more expert. Thus covering both casual and hard-core fans. A different approach could be to have 2 predictions in pre-game, then 1 at the start of each quarter and leaving some prediction for in-game prediction such as asking fans to predict a 2 point shot.
