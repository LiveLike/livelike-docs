---
title: Organizations
excerpt: Collaborate with team members on integrations
deprecated: false
hidden: false
metadata:
  title: ''
...
next:
  ...
  pages:
    - type: basic
      slug: inviting-organization-members
...
Chat Moderators may manage existing chat rooms. They can participate in discussions, act on user reports, and use [tools](doc:cms-chat-moderation) like bans and mutes to uphold community standards.
