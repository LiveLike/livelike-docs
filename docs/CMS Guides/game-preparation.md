...
hidden: false
metadata:
  title: Game Preparation | Producer Suite | LiveLike Developer Hub
  description: >-
    This page covers the basics of game preparation, including how to spark
    conversations, prepare interactions, and more.
  robots: index
next:
  description: ''
---
...
{
  "type": "info",
  "body": "For Twitter, we recommend using TweetDeck to monitor a variety of hashtags and mentions easily. Check out how to [get started with with TweetDeck](https://www.youtube.com/watch?v=MaFF-uy3XqE&t=28s) and [advanced tips](https://www.journalism.co.uk/video/screencast-how-to-create-advanced-search-columns-in-tweetdeck/s400/a556819/). You may also want to keep an eye on the Instagram pages of the teams.",
