...
metadata:
  robots: index
---
Every Application has a set banned words configured for themselves. Read more about it here [[https://docs.livelike.com/docs/cms-chat-moderation](https://docs.livelike.com/docs/cms-chat-moderation)]
