...
[block:code]
{
  "codes": [
    {
      "code": "val session = engagementSDK.createContentSession(\"<program-url>\", object:LiveLikeSDK.TimecodeGetter{\n  override fun getTimecode(): EpochTime {\n    return EpochTime(player.bufferedPosition)\n    }\n})",
      "language": "kotlin"
    },
    {
      "code": "LiveLikeContentSession session = liveLikeSDK.createContentSession(\"<program-url>\", new LiveLikeSDK.TimecodeGetter() {\n  @NotNull\n  @Override\n  public EpochTime getTimecode() {\n    return new EpochTime(player.getEpochTime());\n  }\n});",
      "language": "java"
    }
  ]
}
...
* Live HLS stream
* Stream contains the [EXT-X-PROGRAM-DATE-TIME](https://tools.ietf.org/html/rfc8216#section-
...
[block:code]
{
  "codes": [
    {
      "code": "val session = engagementSDK.createExoplayerSession(\n  object : PlayerProvider {\n    override fun get(): SimpleExoPlayer? {\n      return getPlayer()\n    }\n  },\n  \"<program-url>\"\n)",
      "language": "kotlin"
    },
    {
      "code": "import static com.livelike.livelikepreintegrators.ExoplayerPreintegratorKt.createExoplayerSession;\n\nLiveLikeContentSession session = createExoplayerSession(liveLikeSDK, () -> getPlayerInstance(), \"<program-url>\");",
      "language": "java"
    }
  ]
}
