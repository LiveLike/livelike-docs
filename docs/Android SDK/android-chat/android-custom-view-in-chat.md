...
> 🚧 Note:
>
> **This feature does not support reactions and moderation**
...
> 📘 Message:
>
> By providing the value to delegate the LiveLike ChatView support custom message else it will be ignored by the LiveLike ChatView
