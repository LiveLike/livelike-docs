...
| ------------------------------------------------- | ----------- | -------------------------------------------------------------------------------------------------- | -------------------------------------------- |
| [1.11.0](https://docs.livelike.com/docs/gti-1110) | 17 Aug 2026 | Highlights screen added. The game now sizes itself to its container instead of the browser window. | Optional, plus a check if you use custom CSS |
