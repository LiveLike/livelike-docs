...
- `source_system` – Indicates which platform the data analytics are rendered from (`arcade_frontend` or `arcade_backend`).
- `language` – Shows which language is used by users.
- `region` – Shows the region of the user.
