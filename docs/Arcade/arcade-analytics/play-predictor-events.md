...
| **game\_completed**    | Triggers when user clicks on submit prediction       | `fixture_details`<br />(team names, date, start time)<br />`ll_program_name`<br />`ll_program_id`                                                                                                                                                            | Tracks number of submissions.                           |
