---
title: Chat Asset Guidelines
excerpt: ''
deprecated: false
hidden: false
metadata:
  title: Chat Sticker Guidelines | Design Guidelines | LiveLike
  description: >-
    Check out our chat asset guidelines when designing stickers, reactions and
    sticker packs to be used in chat.
  robots: index
next:
  description: ''
---
