...
>
> Before you can create a widget, you must first create a <Glossary>Program</Glossary> for it to belong to. You can use the `createProgram` mutation to create a new program now, or learn more about [Programs](doc:programs) in the product docs.
...
>
> Poll Votes cannot be created or updated anonymously. Make sure to include the user's Profile <Glossary>Access Token</Glossary> in the Authorization header in requests when working with poll votes.
