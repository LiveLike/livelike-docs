...
As soon as your integration with LiveLike is launched, we start collecting data that can be used to track your success. This data helps you understand your programs’ engagement performance and the usage behaviors of your audience. These understandings can be utilized to attain the most value out of the LiveLike product, resulting in increased participation, engagement, and retention.

There are three views as of now that are available in our analytics dashboard: Applications, Program, and Widget level information. These views have similar filters like organization and application names which can be used to set the filter according to their needs.
...
<Image align="center" border={false} width="smart" src="https://files.readme.io/91f3c7e-ezgif.com-gif-maker.gif" />
...
<Image border={false} src="https://files.readme.io/751ab15-ezgif.com-gif-maker_1.gif" title="ezgif.com-gif-maker (1).gif" />
...
<Image border={false} src="https://files.readme.io/704cc4d-Screenshot_2022-01-24_at_3.57.02_PM.png" title="Screenshot 2022-01-24 at 3.57.02 PM.png" />
...
<Image border={false} src="https://files.readme.io/6c10a0e-Screenshot_2022-01-24_at_11.37.31_PM.png" title="Screenshot 2022-01-24 at 11.37.31 PM.png" />
...
<Image border={false} src="https://files.readme.io/adbc4b0-Screenshot_2024-02-08_at_1.22.00_PM.png" />
...
<Image border={false} src="https://files.readme.io/1b2b584-Screenshot_2024-02-08_at_2.05.26_PM.png" />
