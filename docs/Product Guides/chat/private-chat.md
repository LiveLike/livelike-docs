...
hidden: false
metadata:
  title: Private Chat | LiveLike Developer Hub
  description: >-
    Users can create their own private chat rooms or group chat using the Create
    Chat Room API. Learn more.
  robots: index
next:
  description: ''
---
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6e8b5f6-Private_Chat_Flow.png",
        "Private Chat Flow.png",
        609,
        413,
        "#f4f4f4"
      ]
...
{
  "type": "warning",
  "title": "Sharing chat room IDs between users happens outside of LiveLike",
  "body": "Clients need to know the ID of a chat room to be able to enter it and send messages. LiveLike doesn't provide a way for users to communicate the IDs of chat rooms to each other, so an out-of-band solution like a link that includes the chat room ID is assumed."
}
[/block]
