...
---
Use Chat Room Memberships to track which users are permanent members of rooms, even when they're offline. Being a member of a room is separate from being _present_ in a room, which tracks whether or not someone is online.
