...
> 📘 Use Quests for incentivizing user journeys and funnel optimizations
>
> Reward Tables are great for recurring rewards, like for giving points each time a user votes on a poll or refers a friend. Quests are better for one-time rewards with complex criteria. Read more about [quests](doc:quests) to see how you can use them in your apps.
