...
_Considering a scenario where widget is rendered for the very first time and user interacts with the widget (and presses submit button)._
...
_Considering a scenario where your UI is reloaded and widget rendered already has user interaction._
...
_Considering a scenario where widget is rendered with a given interactivity time out or expiry date time and user does not interacts with the widget._
